...
var reactIconsKit = require('react-icons-kit');
...
var IconPlay = function IconPlay(_ref) {
  var size = _ref.size;
  return React__default.createElement(reactIconsKit.Icon, { size: size, icon: md_261 });
};
var IconPause = function IconPause(_ref2) {
  var size = _ref2.size;
  return React__default.createElement(reactIconsKit.Icon, { size: size, icon: md_258 });
};
