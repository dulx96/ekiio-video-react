...
var IconPlay = function IconPlay(_ref) {
  var size = _ref.size;
  return React.createElement(Icon, { size: size, icon: md_261 });
};
var IconPause = function IconPause(_ref2) {
  var size = _ref2.size;
  return React.createElement(Icon, { size: size, icon: md_258 });
};
  ...
  createClass(PlayToggle, [{
    ...
    value: function render() {
      ...
      return React.createElement(
        ...
        !this.props.player.paused ? React.createElement(IconPause, { size: 20 }) : React.createElement(IconPlay, { size: 20 })
      );
    }
  }]);
  return PlayToggle;
...
PopupButton.propTypes = propTypes$4;
...
VolumeLevel.propTypes = propTypes$6;
...
VolumeBar.propTypes = propTypes$7;
...
VolumeMenuButton.propTypes = propTypes$8;
VolumeMenuButton.displayName = 'VolumeMenuButton';

var ControlBar = function ControlBar(props) {

  var children = [React.createElement(PlayToggle, _extends({ key: 'toggle-play' }, props)), React.createElement(VolumeMenuButton, _extends({ key: 'volume-menu-button' }, props))];
  return React.createElement(
    'div',
...
Shortcut.propTypes = propTypes$9;
  ...
  createClass(Player, [{
    ...
    value: function getDefaultChildren(props, fullProps) {
      ...
      return [React.createElement(Video, _extends({
        ...
        key: 'video'
      }, fullProps)), React.createElement(ControlBar, _extends({ key: 'control-bar'
      }, props)), React.createElement(Shortcut, _extends({ key: 'short-cut'
      }, props))];
    }
  }, {
    key: 'getChildren',
